...
import { Mail, Phone, Calendar, CheckCircle2, Briefcase, GraduationCap, Award } from 'lucide-react';
        ...
        <div className="container">
          ...
          >
            ...
            <p className="text-xl text-slate max-w-2xl mx-auto">
              We're a boutique sales firm specializing in high-ticket B2B closing, helping founders and companies scale their revenue without the overhead of an in-house sales team.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="bg-off-white p-6 rounded-lg shadow-sm"
            >
                ...
                <div className="space-y-6 mt-8">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:contact@millsrevenue.com" className="text-slate hover:text-gold transition-colors">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+17209004934" className="text-slate hover:text-gold transition-colors">
                        (720) 900-4934
                      </a>
                    </div>
                  </div>
